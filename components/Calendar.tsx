'use client'
import { baseRating , gradients } from '@/utils/utils'
...
type CalendarProp = {
 ...
 const  Calendar:FC<CalendarProp> = ({demo,completeData,handleSetMood})=>{
    ...
    return (
        <div className='flex flex-col gap-2'>
            ...
            <div className='flex flex-col overflow-hidden gap-1 py-4 sm:py-6 md:py-10'>
               {
                Array.from({length:numRows},(row,rowIndex)=>{
                  return(
                    <div key={rowIndex} className='grid grid-cols-7 gap-1'>
                            {dayList.map((dayOfWeek, dayOfWeekIndex) => {
                                ...
                                let color = demo ?
                                    gradients.indigo[baseRating[dayIndex.toString() as keyof typeof baseRating]] :
                                    dayIndex in data ?
